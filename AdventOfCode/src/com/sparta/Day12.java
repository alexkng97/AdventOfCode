...
public class Day12 {
    ...
    public ArrayList<String> loadFile(String url){
    ...
    public static void main(String[] args) {
        ...
        day12.moveShip(day12.loadFile("AdventOfCode/day12test.txt"));
        System.out.println(day12.eastWest);
        System.out.println(day12.northSouth);
